...
export function render(DOM, htmlStringResult){

    let fragment = document.createRange().createContextualFragment(htmlStringResult)
    ...
    if(isIniitalRender){
         ...
         */
            ...
            renderedDOM.innerHTML = htmlStringResult
